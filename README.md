...
1. Go to the project directory
   ...
   Then go to the template folder you want to use. For example, if you want to use the Profile template, then go to the pofology folder.
...
![Profile Dark](public/screenshot_01.png)
![Profile Dark](public/screenshot_02.png)
